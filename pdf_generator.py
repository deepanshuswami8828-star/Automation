...
def create_pdf(data):
    ...
    y -= 20
    c.setFont("Helvetica", 12)
    c.drawString(50, y, f"Migration Status: {data['migration']}")
    y -= 150
    c.drawImage(ImageReader("migration.png"), 50, y, width=500, height=120)

    # Repeat for GTmetrix, PSI, SEO, Security, etc.
